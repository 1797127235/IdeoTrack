#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Update sprint-status.yaml for story review status."""
...
for line in lines:
    ...
    if in_dev_status:
        ...
        if stripped.startswith('1-1-xue-hao-gong-hao-mi-ma-deng-lu:'):
            new_lines.append('  1-1-xue-hao-gong-hao-mi-ma-deng-lu: review')
            continue
    new_lines.append(line)
...
print('1-1-xue-hao-gong-hao-mi-ma-deng-lu: review')
